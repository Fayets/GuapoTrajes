                ...
                if estado:
                    ...
                    if is_admin:
                        ...
                        if not user.sucursal:
                            # Usuario sin sucursal, retornar vacío
                            return [], 0
                        sucursal_id = user.sucursal.id
                        q = models.Producto.select(lambda p: p.sucursal.id == sucursal_id and p.estado == estado_enum)
                else:
                    if is_admin:
                        ...
                        if not user.sucursal:
                            ...
                            return [], 0
                        sucursal_id = user.sucursal.id
                        q = models.Producto.select(lambda p: p.sucursal.id == sucursal_id)
