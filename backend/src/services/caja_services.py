...
class CajaServices:
    ...
    @db_session
    def get_movimientos_diarios(self, fecha: date, sucursal_id: int, payment_method: Optional[str] = None) -> List[Dict]:
        ...
        try:
            ...
            for cm in all_movimientos:
                if (cm.fecha_hora.date() == fecha and 
            ...
            for cm in movimientos_filtrados:
                ...
                movimientos.append({
                    ...
                    "origen": cm.origen,
                    "tipo": cm.tipo,
                    "payment_method": cm.payment_method,
                    "categoria": categoria,
                    "monto": cm.monto,
    ...
    def get_totales_diarios(self, fecha: date, sucursal_id: int) -> Dict:
        ...
        try:
            ...
            for cm in movimientos_filtrados:
                metodo = cm.payment_method if cm.payment_method else "SIN_METODO"
        ...
        try:
            ...
            for cm in query:
                ...
                movimientos.append({
                    ...
                    "monto": cm.monto,
                    "payment_method": cm.payment_method,  # Ya es string
                    "origen": cm.origen,
    ...
    def revertir_movimiento_venta(self, venta_id: int, usuario_id: int) -> CajaMovimiento:
        ...
        try:
            ...
            movimiento_data = {
                ...
                "payment_method": movimiento_original.payment_method.value if movimiento_original.payment_method else None,
        ...
        try:
            ...
            for cm in movimientos_presupuestos:
                movimientos.append({
                    ...
                    "origen": cm.origen,
                    "tipo": cm.tipo,
                    "payment_method": cm.payment_method.value if cm.payment_method else None,
                    "monto": cm.monto,
                    "usuario_nombre": f"{cm.usuario.nombre} {cm.usuario.apellido}",
