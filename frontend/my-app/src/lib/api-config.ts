 ...
 * - En producción o si definís NEXT_PUBLIC_API_URL: usa esa URL (ej. https://guapo.evoluciona.cloud/api).
 *
 * Para forzar otro backend: define NEXT_PUBLIC_API_URL en .env.local (ej. http://127.0.0.1:8000).
 */

const API_BASE_PRODUCTION = 'https://guapo.evoluciona.cloud/api';
