    ...
    <div className="d-flex align-items-center justify-content-center min-vh-100 bg-light">
      <div className="card shadow-sm" style={{ width: "400px" }}>
        <div className="card-header text-center bg-white border-bottom-0 pt-4">
          ...
          <p className="card-subtitle text-muted">Ingrese sus credenciales para acceder al sistema</p>
        </div>
        ...
        <div className="card-footer text-center bg-white border-top-0 pb-4">
          <p className="text-muted small mb-0">Sistema de Administración Interna</p>
        </div>
      </div>
    </div>
  )
