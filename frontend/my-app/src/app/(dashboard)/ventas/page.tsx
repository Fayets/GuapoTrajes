...
export default function VentasPage() {
  ...
  const guardarVenta = async () => {
    ...
    const payload = {
      ...
      sucursal_id: me?.sucursalId || 1, // Usar sucursal del usuario
      tipo_precio: tiposPrecio[0], // Tipo de precio principal de la venta
      metodo_pago_id: metodoPagoId, // Nuevo sistema
      submetodo_pago_id: submetodoPagoId || null, // Nuevo sistema (opcional)
