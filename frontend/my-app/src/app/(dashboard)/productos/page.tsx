...
export default function ProductosPage() {
  ...
  const productosFiltrados = productos.filter((producto) =>
    `${producto.linea} ${producto.codigo_barra}`.toLowerCase().includes(busqueda.toLowerCase())
  )
          ...
          <table className="table table-hover mb-0">
            <thead>
              <tr>
                ...
                <th>Precio Alq. Efectivo</th>
                <th>Precio Venta Nuevo Lista</th>
                <th>Precio Venta Nuevo Efectivo</th>
                <th>Precio Medio Uso</th>
                <th>Precio Venta</th>
              ...
              {productosFiltrados.length > 0 ? (
                productosFiltrados.map((producto, index) => (
                  ...
                  <tr key={producto.id || `cliente-${index}`}>
                    ...
                    <td>{producto.precio_alquiler_efectivo}</td>
                    <td>{producto.precio_venta_nuevo_lista}</td>
                    <td>{producto.precio_venta_nuevo_efectivo}</td>
                    <td>{producto.precio_de_venta_medio_uso}</td>
                    <td>{producto.precio_venta}</td>
                    <td>{producto.precio_liquidacion}</td>
                    <td>{producto.stock}</td> {/*Stock ahora representa cantidad de usos*/}
                    <td><select
                    ...
                    <td>
                      <div className="btn-group">
                          ...
                          <Button className="btn btn-sm btn-outline-danger bg-white" 
                            variant="warning" 
                            onClick={() => eliminarProducto(producto.codigo_barra)} title="Eliminar">
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent>
          ...
          <div className="modal-body">
            ...
            <div>
              ...
              <select className="select"
                ...
                onChange={(e)=>
                  setProductoActual({...productoActual!, estado: e.target.value})
                }
              >
          ...
          <div className="modal-footer">
            ...
            <Button className="btn btn-primary" onClick={(e)=>guardarProducto()}>
